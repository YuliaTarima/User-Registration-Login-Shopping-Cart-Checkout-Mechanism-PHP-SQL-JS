...
$sql_insert4 = "INSERT IGNORE INTO " . $table4 .
    "
		...
		('', 1, 'Albert Adams','USPS Ground', 24.22, CURRENT_TIMESTAMP, 'shipped', '1 A Street', 1,
		'Antoich', 'CA', 94531, 'USA'),
		('', 2, 'Brian Brown', 'USPS Ground', 18.59, CURRENT_TIMESTAMP, 'processing order', '2 Bone Drive', 2,
		'Brentwood', 'CA', 94513, 'USA'),
		('', 3, 'Cynthia Clark', 'Express Mail', 23.33, CURRENT_TIMESTAMP, 'delivered', '3 Concord Avenue', 3,
		 'Concord', 'CA', 94520, 'USA'),
		('', 4, 'Donna Davis',  'Express Mail', 230.588, CURRENT_TIMESTAMP, 'shipped', '4 Dracula Court', 4,
		'Davis', 'CA', 95218, 'USA')
	";
